...
export function DashboardStats() {
    return (
        <div>
            <dl className="mt-5 grid grid-cols-1 divide-y divide-zinc-200 overflow-hidden rounded-lg shadow dark:divide-zinc-800 md:grid-cols-3 md:divide-x md:divide-y-0">
                {stats.map(item => (
                    <div key={item.name} className="px-4 py-5 sm:p-6">
                        ...
                        <dd className="mt-1 flex items-baseline justify-between md:block lg:flex">
                            <div className="flex items-baseline text-2xl font-semibold text-zinc-600 dark:text-zinc-300">
                                {item.stat}
